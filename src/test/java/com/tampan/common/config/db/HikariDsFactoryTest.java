...
public class HikariDsFactoryTest {


    @InjectMocks
    HikariDsFactory hikariDsFactory;
    ...
    public void testSplitConnectionString()
    {
        ...
        String result=hikariDsFactory.getSlaveJdbcUrl("jdbc:postgresql://dbtablemgmt-exp-master-andy.ch0lnhgocapc.ap-southeast-1.rds.amazonaws.com:5432/postgres"
